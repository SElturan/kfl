...
from .models import Teams, Players, Standings, Matches, EventsMathes, StaticticsPlayerSeason
...
class StandingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Standings
        fields = ['id', 'team_name', 'season', 'games', 'wins', 'draws', 'losses', 'goals_scored', 'goals_conceded', 'points']
...
class MatchesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Matches
        fields = ['id', 'home_team_name', 'away_team_name', 'date_match', 'home_goals', 'away_goals', 'stadium', 'status']
